  ...
  return (
    <main style={{ padding: '2rem 5% 8rem 5%' }}>
      ...
      <header style={{ marginBottom: '3rem' }}>
        <Reveal>
          <h1 style={{ fontSize: '2.5rem' }}>Team <span className="vibrant-gradient-text">Squads</span></h1>
        </Reveal>
        <Reveal delay={0.1}>
              ...
              <Tilt>
                <section className="glass-card">
                  <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '2rem', borderBottom: '1px solid var(--glass-border)', paddingBottom: '1rem' }}>
                    <div>
                      <h2 className="vibrant-gradient-text" style={{ fontSize: '1.8rem' }}>{team.Team_Name}</h2>
